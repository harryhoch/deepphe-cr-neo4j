...
//                            .forEach(diagnoses::add);
    ...
    public static void main(final String... args) {
        ...
        Map<String,String> diagnosisGroupNames = UriConstants.getDiagnosisGroupNames( functions.graphDb );
        for (Map.Entry<String,String> entry: diagnosisGroupNames.entrySet()) {
